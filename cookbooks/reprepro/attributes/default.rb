...
default['reprepro']['disable_databag'] = true

default['reprepro']['nginx']['listen_port'] = 80
default['reprepro']['nginx']['ssl'] = false
default['reprepro']['nginx']['ssl_certificate'] = nil
default['reprepro']['nginx']['ssl_certificate_key'] = nil
default['reprepro']['pgp_email']="mahesh.vummidichetty@ul.com"
default['gpg']['name']['email']="trusty"
default['gpg']['user'] ="vagrant"
default['gpg']['name']['real'] = "vagrant"
